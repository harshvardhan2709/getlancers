...
const AboutPage = () => {
  return (
    <div className="container mx-auto px-4 py-16">
      <h1 className="text-4xl font-bold mb-8 text-center">About getLancer</h1>
      
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-md p-8 mb-12">
          <h2 className="text-2xl font-semibold mb-4">Our Mission</h2>
          <p className="text-gray-700 mb-6">
            At getLancer, we are on a mission to revolutionize how freelancers and businesses connect. 
          ...
          <p className="text-gray-700 mb-6">
            Founded in 2024, getLancer has quickly grown into a trusted platform for freelancers 
            and clients alike. Our team is passionate about building a community where skills are 
